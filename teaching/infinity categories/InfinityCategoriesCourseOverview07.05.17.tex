...
\href{InfCat2SS.pdf}{[Danijela's notes (scanned pdf), used with permission]} \\%
\\ 
...
Given examples $0, 1, 2, 3, \omega, \omega {+} 1, \omega {+} 2, 2 \omega, 2 \omega {+} 1, \omega^2, \omega^2 {+} 2 \omega {+} 1, \omega_1, \omega_2, \omega_\omega$. %
Define a successor (resp. limit) ordinal to be one admitting (resp. not admitting) a maximal element. %
Define a \emph{cardinal} as an equivalence class of ordinals, and explain why this is a lie. [*** in general the difference between big categories and small categoeis***]%
...
Define a \emph{regular ordinal} to be an ordinal $\alpha$, such that for cofinal $N(\beta) \to N(\alpha)$, we have $|\beta| \geq |\alpha|$. %
Define a \emph{regular cardinal} to be the cardinality of a regular ordinal. %
Observe that regular cardinals correspond to classes of filtered colimits. %
...
Define the ind-category $Ind_\kappa(C^0)$ of a small ∞-category $C^0$ [HTT, ***]. %
Define $\kappa$-accessible [HTT, Def.5.4.2.1]. %
...
Define a $\kappa$-filtered colimit [***]. %
